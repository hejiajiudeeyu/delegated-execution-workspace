...
assert.equal(byCommand.get("corepack pnpm run deployability:explain").category, "top_level");
assert.equal(byCommand.get("corepack pnpm run deployability:explain").posture, "read_only");
assert.equal(byCommand.get("corepack pnpm run deployability:explain").dashboard_safe, true);
assert.ok(byCommand.get("corepack pnpm run deployability:explain").track_keys.includes("daily_dev"));
assert.equal(byCommand.get("corepack pnpm run deployability:production").category, "top_level");
...
assert.ok(byCommand.get("corepack pnpm run deployability:readiness").track_keys.includes("daily_dev"));
assert.equal(byCommand.get("corepack pnpm run deployability:prd").category, "top_level");
...
assert.ok(byCommand.get("corepack pnpm run deployability:prd").track_keys.includes("daily_dev"));
assert.equal(byCommand.get("corepack pnpm run deployability:roadmap").category, "top_level");
...
assert.ok(byCommand.get("corepack pnpm run deployability:roadmap").track_keys.includes("daily_dev"));
assert.equal(byCommand.get("corepack pnpm run deployability:status").category, "top_level");
...
assert.ok(byCommand.get("corepack pnpm run deployability:status").track_keys.includes("daily_dev"));
assert.equal(byCommand.get("corepack pnpm run deployability:gates").category, "top_level");
assert.equal(byCommand.get("corepack pnpm run deployability:gates").posture, "read_only");
assert.equal(byCommand.get("corepack pnpm run deployability:gates").dashboard_safe, true);
assert.ok(byCommand.get("corepack pnpm run deployability:gates").track_keys.includes("daily_dev"));
assert.equal(byCommand.get("corepack pnpm run deployability:exposure").category, "top_level");
...
assert.ok(
  byCommand
    .get("corepack pnpm run deployability:operator-checklist -- --profile public-stack --image-tag <candidate-tag>")
    .track_keys.includes("daily_dev")
);
assert.ok(
  byCommand
    .get("corepack pnpm run deployability:operator-checklist -- --profile public-stack --image-tag <candidate-tag>")
    .pipeline_keys.includes("public_stack")
);
assert.equal(byCommand.get("corepack pnpm run deployability:evidence -- --profile public-stack").category, "top_level");
assert.equal(byCommand.get("corepack pnpm run deployability:evidence -- --profile public-stack").posture, "writes_report");
assert.equal(byCommand.get("corepack pnpm run deployability:evidence -- --profile public-stack").dashboard_safe, true);
assert.ok(byCommand.get("corepack pnpm run deployability:evidence -- --profile public-stack").track_keys.includes("daily_dev"));
assert.ok(byCommand.get("corepack pnpm run deployability:evidence -- --profile public-stack").pipeline_keys.includes("public_stack"));
...
assert.ok(
  topLevelBody.commands.some(
    (item) => item.command === "corepack pnpm run deployability:operator-checklist -- --profile public-stack --image-tag <candidate-tag>"
  )
);
assert.ok(topLevelBody.commands.some((item) => item.command === "corepack pnpm run deployability:evidence -- --profile public-stack"));
...
assert.ok(dailyDevBody.commands.some((item) => item.command === "corepack pnpm run deployability:explain"));
assert.ok(dailyDevBody.commands.some((item) => item.command === "corepack pnpm run deployability:production"));
assert.ok(dailyDevBody.commands.some((item) => item.command === "corepack pnpm run deployability:readiness"));
assert.ok(dailyDevBody.commands.some((item) => item.command === "corepack pnpm run deployability:prd"));
assert.ok(dailyDevBody.commands.some((item) => item.command === "corepack pnpm run deployability:roadmap"));
...
assert.ok(dailyDevBody.commands.some((item) => item.command === "corepack pnpm run deployability:evidence -- --profile public-stack"));
