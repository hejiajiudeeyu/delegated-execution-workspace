...
assert.equal(byCommand.get("corepack pnpm run deployability:explain").reads_env, false);
...
assert.equal(byCommand.get("corepack pnpm run deployability:gates").reads_env, false);
assert.equal(byCommand.get("corepack pnpm run deployability:gates").calls_docker, false);
assert.equal(byCommand.get("corepack pnpm run deployability:gates").probes_network, false);
...
assert.equal(byCommand.get("corepack pnpm run deployability:exposure").reads_env, true);
assert.equal(byCommand.get("corepack pnpm run deployability:exposure").writes_files, false);
assert.equal(byCommand.get("corepack pnpm run deployability:exposure").starts_services, false);
assert.equal(byCommand.get("corepack pnpm run deployability:exposure").calls_docker, true);
assert.equal(byCommand.get("corepack pnpm run deployability:exposure").probes_network, false);
assert.equal(byCommand.get("corepack pnpm run deployability:exposure").public_exposure_gate, true);
...
assert.equal(byCommand.get("corepack pnpm run deployability:release -- --image-tag <candidate-tag>").reads_env, true);
assert.equal(byCommand.get("corepack pnpm run deployability:release -- --image-tag <candidate-tag>").writes_files, false);
assert.equal(byCommand.get("corepack pnpm run deployability:release -- --image-tag <candidate-tag>").starts_services, false);
assert.equal(byCommand.get("corepack pnpm run deployability:release -- --image-tag <candidate-tag>").calls_docker, true);
