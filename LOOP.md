...
| 1.3 | 打新 `platform-console-gateway` 镜像（含 T-504 recovery+UI），补 release notes；**前置 = main CI 绿灯（1.0a/1.0b），不再带红灯发布** | `repos/platform` | todo(前置已满足) | 现网 v0.1.5；参考 `docs/archive/releases/` 惯例;platform main CI 已三连绿(28684633860/28685820610/28687505922),1.0b 为稀有 flake 且诊断在岗,"不带红灯发布"精神已满足 |
