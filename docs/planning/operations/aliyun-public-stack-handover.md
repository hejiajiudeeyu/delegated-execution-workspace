...
## 当前版本(2026-08-10 起:v0.4.17)

| 服务 | 镜像 | 说明 |
|------|------|------|
| platform-console-gateway | `rsp-gateway:v0.4.17` | |
| platform-api | `rsp-platform:v0.4.17` | |
| relay | `rsp-relay:v0.4.17` | 启动日志应显示 `auth=required`;**已带鉴权重开公网**(D6.1),`/relay/buildz` 公网可直测 |
