...
- `selfhost:readiness -- --all` 已成为只读多 profile readiness 矩阵，
  `selfhost:readiness` 继续作为选定 profile 的 readiness 总览
...
`selfhost:profiles`、`selfhost:quickstart`、`selfhost:readiness -- --all`、`selfhost:readiness`、`selfhost:doctor`、`selfhost:summary`、`selfhost:ports`、`selfhost:ops-report`、`selfhost:backup-validate`、
