...
delegated-execution-protocol is part of protocol truth source. Quality means preserving the owning repository boundary, keeping tests near the behavior, and proving cross-repo compatibility when contracts or submodule SHAs move.
...
- Change protocol semantics here first, then update client/platform consumers and docs.
