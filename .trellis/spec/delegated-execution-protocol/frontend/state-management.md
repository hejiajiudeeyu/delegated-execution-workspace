...
delegated-execution-protocol manages runtime, request, store, transport, or protocol state outside React. State should be explicit, serializable where possible, and owned by the package that persists or serves it.
