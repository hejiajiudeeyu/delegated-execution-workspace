...
@delexec/responder-runtime-core is a responder executor runtime package under `repos/client/packages/responder-runtime-core`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/packages/responder-runtime-core/src/index.js` or `repos/client/packages/responder-runtime-core/src/server.js`.
...
- Use repos/client/packages/responder-runtime-core/src/index.js as a current reference.
- Use repos/client/packages/responder-runtime-core/src/executors.js as a current reference.
- Use repos/client/tests/unit/executors.test.js as a current reference.
