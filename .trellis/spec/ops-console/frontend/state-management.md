...
@delexec/ops-console uses local React state, context for auth/session concerns, URL state for selected views, and server state loaded through local API helpers.
