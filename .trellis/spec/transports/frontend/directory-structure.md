...
transports package family is a transport adapter family under `repos/client/packages/transports`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/packages/transports/src/index.js` or `repos/client/packages/transports/src/server.js`.
