...
@delexec/postgres-store is a Postgres persistence package under `repos/platform/packages/postgres-store`.
...
- Runtime source is intentionally small and package-local, usually `repos/platform/packages/postgres-store/src/index.js` or `repos/platform/packages/postgres-store/src/server.js`.
