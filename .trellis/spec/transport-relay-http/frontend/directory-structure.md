...
@delexec/transport-relay-http is a relay-http transport adapter package under `repos/client/packages/transports/relay-http`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/packages/transports/relay-http/src/index.js` or `repos/client/packages/transports/relay-http/src/server.js`.
