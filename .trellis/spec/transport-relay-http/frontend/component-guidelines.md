...
@delexec/transport-relay-http is not primarily a React component package. Do not invent a component layer here; route UI work to the console/site package that owns the screen.
