...
@delexec/sqlite-store is a SQLite client state package under `repos/client/packages/sqlite-store`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/packages/sqlite-store/src/index.js` or `repos/client/packages/sqlite-store/src/server.js`.
