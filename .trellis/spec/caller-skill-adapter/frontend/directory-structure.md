...
@delexec/caller-skill-adapter is a caller skill adapter service under `repos/client/apps/caller-skill-adapter`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/apps/caller-skill-adapter/src/index.js` or `repos/client/apps/caller-skill-adapter/src/server.js`.
...
- Use repos/client/apps/caller-skill-adapter/src/server.js as a current reference.
- Use repos/client/tests/integration/caller-skill-adapter.integration.test.js as a current reference.
