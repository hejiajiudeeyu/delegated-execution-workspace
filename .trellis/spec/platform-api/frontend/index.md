...
Guidelines for @delexec/platform-api, a Node HTTP platform API under `repos/platform/apps/platform-api`.
...
| Platform Service Resolution | [service-resolution.md](./service-resolution.md) | Active |
