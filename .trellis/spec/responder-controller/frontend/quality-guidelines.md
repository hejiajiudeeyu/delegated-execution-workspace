...
@delexec/responder-controller is part of Node HTTP responder controller. Quality means preserving the owning repository boundary, keeping tests near the behavior, and proving cross-repo compatibility when contracts or submodule SHAs move.
