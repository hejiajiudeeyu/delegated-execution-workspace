...
@delexec/transport-emailengine is a emailengine transport adapter package under `repos/client/packages/transports/emailengine`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/packages/transports/emailengine/src/index.js` or `repos/client/packages/transports/emailengine/src/server.js`.
