...
@delexec/billing-store is a platform billing store package under `repos/platform/packages/billing-store`.
...
- Runtime source is intentionally small and package-local, usually `repos/platform/packages/billing-store/src/index.js` or `repos/platform/packages/billing-store/src/server.js`.
