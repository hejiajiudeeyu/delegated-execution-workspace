...
@delexec/ops is part of end-user CLI and local supervisor. Quality means preserving the owning repository boundary, keeping tests near the behavior, and proving cross-repo compatibility when contracts or submodule SHAs move.
...
- Use repos/client/apps/ops/src/config.js as a current reference.
- Use repos/client/apps/ops/src/supervisor.js as a current reference.
