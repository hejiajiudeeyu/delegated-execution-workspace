...
@delexec/ops is a end-user CLI and local supervisor under `repos/client/apps/ops`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/apps/ops/src/index.js` or `repos/client/apps/ops/src/server.js`.
