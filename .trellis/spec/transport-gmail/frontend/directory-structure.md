...
@delexec/transport-gmail is a gmail transport adapter package under `repos/client/packages/transports/gmail`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/packages/transports/gmail/src/index.js` or `repos/client/packages/transports/gmail/src/server.js`.
