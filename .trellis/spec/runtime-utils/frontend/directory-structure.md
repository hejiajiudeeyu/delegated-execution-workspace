...
@delexec/runtime-utils is a shared runtime utility package under `repos/client/packages/runtime-utils`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/packages/runtime-utils/src/index.js` or `repos/client/packages/runtime-utils/src/server.js`.
...
- Use repos/client/tests/unit/runtime-utils.test.js as a current reference.
