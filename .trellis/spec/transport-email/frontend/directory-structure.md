...
@delexec/transport-email is a email transport adapter package under `repos/client/packages/transports/email`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/packages/transports/email/src/index.js` or `repos/client/packages/transports/email/src/server.js`.
