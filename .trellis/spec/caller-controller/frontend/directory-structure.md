...
@delexec/caller-controller is a Node HTTP caller controller under `repos/client/apps/caller-controller`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/apps/caller-controller/src/index.js` or `repos/client/apps/caller-controller/src/server.js`.
