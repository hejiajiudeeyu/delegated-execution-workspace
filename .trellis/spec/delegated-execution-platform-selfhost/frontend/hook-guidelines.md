...
delegated-execution-platform-selfhost is a runtime/service/package area. Avoid React hooks here; use ordinary functions, async helpers, or server factories.
