...
@delexec/transport-local is a local transport adapter package under `repos/client/packages/transports/local`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/packages/transports/local/src/index.js` or `repos/client/packages/transports/local/src/server.js`.
...
- Use repos/client/packages/transports/local/src/index.js as a current reference.
- Use repos/client/tests/unit/local-transport.test.js as a current reference.
