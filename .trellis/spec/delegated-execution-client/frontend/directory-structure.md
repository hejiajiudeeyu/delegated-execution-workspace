...
delegated-execution-client is a client repository umbrella under `repos/client`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/src/index.js` or `repos/client/src/server.js`.
