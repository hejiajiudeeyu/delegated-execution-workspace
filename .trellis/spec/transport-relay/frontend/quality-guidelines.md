...
@delexec/transport-relay is part of Node HTTP relay service. Quality means preserving the owning repository boundary, keeping tests near the behavior, and proving cross-repo compatibility when contracts or submodule SHAs move.
...
- Run `npm --prefix repos/platform run test:e2e` when this area changes.
