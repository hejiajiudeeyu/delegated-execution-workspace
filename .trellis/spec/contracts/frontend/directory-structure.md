...
@delexec/contracts is a protocol contract package under `repos/protocol/packages/contracts`.
...
- Runtime source is intentionally small and package-local, usually `repos/protocol/packages/contracts/src/index.js` or `repos/protocol/packages/contracts/src/server.js`.
