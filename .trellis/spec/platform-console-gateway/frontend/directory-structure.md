...
@delexec/platform-console-gateway is a Node HTTP console gateway under `repos/platform/apps/platform-console-gateway`.
...
- Runtime source is intentionally small and package-local, usually `repos/platform/apps/platform-console-gateway/src/index.js` or `repos/platform/apps/platform-console-gateway/src/server.js`.
