...
@delexec/caller-skill-mcp-adapter is a MCP adapter service under `repos/client/apps/caller-skill-mcp-adapter`.
...
- Runtime source is intentionally small and package-local, usually `repos/client/apps/caller-skill-mcp-adapter/src/index.js` or `repos/client/apps/caller-skill-mcp-adapter/src/server.js`.
...
- Use repos/client/apps/caller-skill-mcp-adapter/src/server.js as a current reference.
- Use repos/client/tests/integration/caller-skill-mcp-adapter.integration.test.js as a current reference.
